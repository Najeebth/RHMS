...
//         else {
//                 $sql = "INSERT INTO `inquiries`(`house_id`, `tenant_id`, `landlord_id`, `inquiry_date`, `statuss`) VALUES ('$house_id', '$tenant_id', '$landlord_id', '$dates', '0')";
...
<div class="container-fluid">
    <h1 class="h3 mb-4 text-gray-800"> Viewing Dates Details</h1>
    <div class="row">
       <!--  <div class="col-lg-6">

                      ...
                      if($choose == 'all'){
                        ...
                        do{
                         ...
                         /* echo '<tr>';
                          ...
                          echo '<tr>';
                          echo "<td>Duration of Occupying(months):</td>";
                          echo "<td style = 'color:blue;'>".$row['duration_month']."</td>";
                          echo '<tr>';

                          echo '<tr>';
                          echo "<td>Total Rent :</td>";
                          echo "<td style = 'color:blue;'>".number_format($row['total_rent'])."/-</td>";
                          echo '<tr>';

                          echo '<tr>';
                          echo "<td>Deposit:</td>";
                          echo "<td style = 'color:blue;'>".$row['deposit']."</td>";
                          echo '<tr>';

                          echo '<tr>';
                          echo "<td>Total Rent per Month:</td>";
                        ...
                        echo "<script> alert('No active contract') </script>";
                      }
                      }
                    }

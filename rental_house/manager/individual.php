<!-- <div class="row"> -->			
  <div class="col-md-11 col-xs-12 col-sm-12">
  	<div class="alert alert-info" role="alert">
		...
		?>
  		<h2 class="text-center">Register Home</h2>
  		<form action="" method="post" enctype="multipart/form-data">
		  	 <div class="row">
		  	 	<div class="col-md-4">
			  	  <div class="form-group">
				    <label for="fullname">House Name</label>
			...
			<div class="row">
			 ...
			 <div class="form-group">
			  ...
			  <div class="form-group">
			    ...
			    <input type="landmark" class="form-control" id="landmark" placeholder="code of embedded map(small)" name="landmark">
			  </div>
			   </div>
			  <div class="col-md-4">
			  <div class="form-group">

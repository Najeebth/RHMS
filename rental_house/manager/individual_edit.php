			...
			<div class="row">
			 ...
			 <div class="form-group">
			  ...
			  <div class="form-group">
			    ...
			    <input type="landmark" class="form-control" id="landmark" placeholder="landmark" name="landmark" value=" " required>
			  </div>
			   </div> -->
			  <div class="col-md-4">
			  <div class="form-group">
			 ...
			 <!--	<div class="col-md-4">
			  ...
			  <div class="form-group">
			   ...
			   <input type="file" name="image" id="image" value="<?#php echo $data['image']?$data['image']:''; ?>" >
			  </div>
			  </div>  -->
			  </div>			

...
<!-- 
                       <tr>
                         ...
                         <td> <input type='text' class='form-control form-control-user' name='prev' required></td>
                       </tr>
 -->
                     <tr>
                       <td>
                       ...
                       <td>
                          <input type='text' class='form-control form-control-user' name='new' required>
                       </td>
                     </tr>
                     <tr>
                     <td></td>
                   ...
                   if(isset($_POST["submit"])){
                     ...
                     if(!is_numeric($prev) || !is_numeric($new)){
                       ...
                       $sql = "UPDATE room_rental_registrations SET rent= '$new' WHERE id = ' $propertyId '";
